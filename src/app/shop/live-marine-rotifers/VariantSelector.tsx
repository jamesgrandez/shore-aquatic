...
type Size = "1/2 Gallon" | "1 Gallon" | "2 Gallon";
type Fulfillment = "Local Pickup" | "Overnight Shipping" | "2-Day Shipping";

const PRICING: Record<Size, Record<Fulfillment, number>> = {
  "1/2 Gallon": { "Local Pickup":  75, "Overnight Shipping": 125, "2-Day Shipping": 105 },
  "1 Gallon":   { "Local Pickup": 125, "Overnight Shipping": 175, "2-Day Shipping": 155 },
  "2 Gallon":   { "Local Pickup": 200, "Overnight Shipping": 250, "2-Day Shipping": 230 },
};

const APPROX_COUNT: Record<Size, string> = {
  "1/2 Gallon": "~0.95 – 1.9 million",
  "1 Gallon":   "~1.9 – 3.8 million",
  "2 Gallon":   "~3.8 – 7.6 million",
};

const SIZES: Size[] = ["1/2 Gallon", "1 Gallon", "2 Gallon"];
...
export default function VariantSelector() {
  const [size, setSize] = useState<Size>("1 Gallon");
    ...
    <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 sm:p-8">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-xs text-slate-500">Sold by volume</span>
        </div>
      ...
      <div className="rounded-xl bg-gradient-to-br from-aqua-400/10 to-cyan-400/5 border border-aqua-400/20 p-5 mb-4">
        <div className="flex items-baseline justify-between">
          <div>
            ...
            <div className="text-xs text-slate-500 mt-1">{count} rotifers (approx.)</div>
          </div>
